...
const FeeStructureDetailModal: React.FC<FeeStructureDetailModalProps> = ({ 
  ...
  useEffect(() => {
    console.log('forceEditMode useEffect - forceEditMode:', forceEditMode, 'isOpen:', isOpen);
    if (forceEditMode && isOpen) {
      console.log('Setting edit mode to true and populating edit data');
      setIsEditMode(true);
  ...
  console.log('FeeStructureDetailModal render - isOpen:', isOpen, 'forceEditMode:', forceEditMode, 'feeStructure:', feeStructure);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[10001]">
      <div className="bg-blue-50 rounded-lg shadow-xl max-w-xl w-full mx-4 max-h-[70vh] overflow-hidden">
        {/* Modal Header */}
            ...
            <div key={feature.tag} className="bg-white/50 rounded-lg p-3 shadow-sm">
              ...
              <div className="space-y-0.5">
                {feature.details.map((detail, detailIndex) => (
                  <div key={detailIndex} className="flex justify-between items-center py-1 border-b border-gray-100 last:border-b-0">
