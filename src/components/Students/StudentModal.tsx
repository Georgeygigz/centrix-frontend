      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-4">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-2.5 border border-purple-200 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              {FaUserFriends({ className: "w-5 h-5 text-purple-700" })}
              <h3 className="text-lg font-bold text-purple-900">Parents</h3>
            </div>
            <button
                ...
                <div className="space-y-2">
                  ...
                  {loadingParents ? (
                    ...
                    studentParents.map((parentRel, index) => (
                      <div key={parentRel.id} className={`${index > 0 ? 'border-t border-purple-200 pt-2' : ''}`}>
                        <div className="flex justify-between items-center py-1 border-b border-purple-200">
                          ...
                          <span className="text-xs font-medium text-purple-900 bg-purple-50 px-2 py-1 rounded">
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {parentRel.can_pick_up && (
                        <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">Pick Up</span>
                      )}
                    </div>
                                  <button
